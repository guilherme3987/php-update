...
btn.addEventListener("click",(event) => {
    ...
    if((testeNome === " ")   || (testeNome.lenght<3) || (testeCell === " " ) || (testeCell < 8 ) || ((testeEmail === " ") || (testeSenha <8) || (testeSenha === " ")|| !(EmailValidacao(testeEmail)))){
      ...
      window.open ('/opt/lampp/htdocs/projeto/calculopag.html', "_blank");
